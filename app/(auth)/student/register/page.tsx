            ...
            <div className="w-full lg:w-1/2 flex items-center justify-center p-6 md:p-12 relative">
                ...
                >
                    ...
                    <div className="mb-10">
                        ...
                        <h2 className="text-3xl font-bold text-zinc-900 mb-2 tracking-tight">Join as Student</h2>
                        <p className="text-zinc-500">Create your account to start requesting calls.</p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <div className="space-y-1.5">
                            <label className="text-sm font-medium text-zinc-700 ml-1">Personal Email address</label>
                    ...
                    <p className="mt-8 text-center text-sm text-zinc-500">
                        ...
                        <Link href="/student/login" className="text-zinc-900 lg:text-indigo-600 font-bold hover:underline decoration-indigo-300 underline-offset-4 transition-all">
                            Sign in here
                        </Link>
                    </p>
                </motion.div>

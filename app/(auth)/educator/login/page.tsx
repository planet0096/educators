            ...
            <div className="w-full lg:w-1/2 flex items-center justify-center p-6 md:p-12 relative">
                ...
                >
                    ...
                    <div className="mb-10">
                        ...
                        <h2 className="text-3xl font-bold text-zinc-900 mb-2 tracking-tight">Educator Login</h2>
                        <p className="text-zinc-500">Sign in to manage your profile and wallet.</p>
                    </div>
                    ...
                    <p className="mt-8 text-center text-sm text-zinc-500">
                        ...
                        <Link href="/educator/register" className="text-zinc-900 lg:text-emerald-600 font-bold hover:underline decoration-emerald-300 underline-offset-4 transition-all">
                            Apply now
                        </Link>
                    </p>
                </motion.div>
